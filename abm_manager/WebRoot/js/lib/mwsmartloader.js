/**
 * jQuery mwsmartUI 1.4
 * 
 * Copyright (c) 2009-2014 www.jmwsmartui.com. All rights reserved.
 *
 * Licensed under the GPL license: http://www.gnu.org/licenses/gpl.txt
 * To use it on other terms please contact us at info@jmwsmartui.com
 *
 */
(function(){
...
var _2={"af":"mwsmartui-lang-af.js","ar":"mwsmartui-lang-ar.js","bg":"mwsmartui-lang-bg.js","ca":"mwsmartui-lang-ca.js","cs":"mwsmartui-lang-cs.js","cz":"mwsmartui-lang-cz.js","da":"mwsmartui-lang-da.js","de":"mwsmartui-lang-de.js","el":"mwsmartui-lang-el.js","en":"mwsmartui-lang-en.js","es":"mwsmartui-lang-es.js","fr":"mwsmartui-lang-fr.js","it":"mwsmartui-lang-it.js","jp":"mwsmartui-lang-jp.js","nl":"mwsmartui-lang-nl.js","pl":"mwsmartui-lang-pl.js","pt_BR":"mwsmartui-lang-pt_BR.js","ru":"mwsmartui-lang-ru.js","sv_SE":"mwsmartui-lang-sv_SE.js","tr":"mwsmartui-lang-tr.js","zh_CN":"mwsmartui-lang-zh_CN.js","zh_TW":"mwsmartui-lang-zh_TW.js"};
var _3={};
function _4(_5,_6){
var _7=false;
...
var _13=_1[_11];
var _14="loading";
var _15=(mwsmartloader.css&&_13["css"])?"loading":"loaded";
if(mwsmartloader.css&&_13["css"]){
if(/^http/i.test(_13["css"])){
var url=_13["css"];
}else{
var url=mwsmartloader.base+"themes/"+mwsmartloader.theme+"/"+_13["css"];
}
_c(url,function(){
_15="loaded";
...
var url=mwsmartloader.base+"plugins/"+_13["js"];
}
_4(url,function(){
_14="loaded";
if(_14=="loaded"&&_15=="loaded"){
...
if(mwsmartloader.locale&&_1a==true&&_2[mwsmartloader.locale]){
var url=mwsmartloader.base+"locale/"+_2[mwsmartloader.locale];
_9(url,function(){
_1c();
});
}else{
...
mwsmartloader={modules:_1,locales:_2,base:".",theme:"default",css:true,locale:null,timeout:2000,load:function(_1f,_20){
if(/\.css$/i.test(_1f)){
if(/^http/i.test(_1f)){
_c(_1f,_20);
}else{
_c(mwsmartloader.base+_1f,_20);
}
}else{
if(/\.js$/i.test(_1f)){
if(/^http/i.test(_1f)){
...
var m=src.match(/mwsmartloader\.js(\W|$)/i);
if(m){
mwsmartloader.base=src.substring(0,m.index);
}
}
window.using=mwsmartloader.load;
if(window.jQuery){
jQuery(function(){
mwsmartloader.load("parser",function(){
jQuery.parser.parse();
});
});
}
