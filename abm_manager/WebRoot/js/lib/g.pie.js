(function () {
    ...
    function Piechart(paper, cx, cy, r, values, opts) {
        ...
        var legend = function (labels, otherslabel, mark, dir,issingle) {
            var x = cx + r + r / 5,
                y = cy,
                h = y + 10;
			...
			//modified by tpan,当有多个饼图同时出现的时候，legend的文字会向上跑
            if(issingle){
        ...
        if (opts.legend) {
            legend(opts.legend, opts.legendothers, opts.legendmark, opts.legendpos,opts.legendsingle);
        }
