draw2d.ExclusiveGateway=function(_url){
	_url = './js/lib/designer/icons/type.gateway.exclusive.png';
...
draw2d.ExclusiveGateway.prototype.figureDoubleClick = function() {
	...
	var d = c.event;
	nodeid = d.getId();
	sys_act.openProperties(nodeid, "exclusiveGateWay", "gateway")
};
draw2d.ExclusiveGateway.prototype.getContextMenu=function(){
	...
	menu.appendMenuItem(new draw2d.ContextMenuItem("属性", "properties-icon",data,function(x,y)
	{
		...
		if (typeof sys_act.openProperties != "undefined") {
			sys_act.openProperties(tid, "exclusiveGateWay", "gateway")
		}
	}));
