...
<body>
	<form id="human_patronage_import" method="post" enctype = "multipart/form-data">
		...
		<div class="tck_tr" style="width:450px; margin-bottom:10px; padding-left:20px;">
			<p>
				...
				<span style="font-weight:bold;">重要提示</span>:<br/>&nbsp;&nbsp;导入的Excel文件必须是以模板为格式基础添加数据,请勿修改模板格式<br/> 下载模板请点击此处&nbsp;<span style="color:#2C991A;"><a  href="././././file/PatronageImport.xls">&rarr;模板下载&larr;</a></span>&nbsp;</span>
			</p>
		</div>
